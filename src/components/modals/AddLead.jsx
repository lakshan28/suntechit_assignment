  ...
  return (
    ...
    >
      ...
      <img
        className={
          leadTitleAni
            ? "addLeadbeforefilling"
            : leadPersonal
            ? "addLeadAfterTitlefilling"
            : leadContact
            ? "addLeadAfterFillingName"
            : leadExtraDetails
            ? "addLeadAfterFillingContact"
            : leadExtraDetailsTask
            ? "addLeadAfterFillingExtraDetails"
            : "addLeadAfterFillingExtraDetailsTask"
        }
        src={greenback}
      />
      <Card
...
const mapDispatchToProps = dispatch => ({
  addCard: (name, text, textCard, price, listID) =>
    dispatch(addCard(name, text, textCard, price, listID))
});
